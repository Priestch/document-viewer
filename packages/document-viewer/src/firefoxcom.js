...
import "../pdf.js/extensions/firefox/tools/l10n.js";
...
import { DEFAULT_SCALE_VALUE } from "../pdf.js/web/ui_utils.js";
      ...
      if (queryId === "canDownloadInsteadOfPrint") {
        ...
        if (pdfDocument) {
          try {
            ...
            const hasWillPrint =
              pdfViewer.enableScripting && !!(await pdfDocument.getJSActions())?.WillPrint;
            const hasUnchangedOptionalContent = (await pdfViewer.optionalContentConfigPromise)
