...
function createHelper(PDFViewerApplication) {
  const {appOptions: AppOptions} = PDFViewerApplication;
  ...
  async function loadPDFBug(self) {
    ...
    const {PDFBug} = typeof PDFJSDev === "undefined" ? await import(debuggerScriptPath) : await __non_webpack_import__(debuggerScriptPath);
    self._PDFBug = PDFBug;
  }
  ...
  function webViewerWheel(evt) {
    ...
    const isBuiltInMac = typeof PDFJSDev !== "undefined" && PDFJSDev.test("MOZCENTRAL") && FeatureTest.platform.isMac;
