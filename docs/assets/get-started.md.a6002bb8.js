import{_ as s,c as a,o as n,Q as e}from"./chunks/framework.ce509e38.js";const E=JSON.parse('{"title":"PDF Viewer","description":"","frontmatter":{},"headers":[],"relativePath":"get-started.md","filePath":"get-started.md","lastUpdated":1695564877000}'),p={name:"get-started.md"},l=e(`<h1 id="pdf-viewer" tabindex="-1">PDF Viewer <a class="header-anchor" href="#pdf-viewer" aria-label="Permalink to &quot;PDF Viewer&quot;">​</a></h1><p>An out-of-the-box PDF viewer builds on PDF.js.</p><h2 id="quick-start" tabindex="-1">Quick Start <a class="header-anchor" href="#quick-start" aria-label="Permalink to &quot;Quick Start&quot;">​</a></h2><p>You can use the starter to initialize a demo app to explore how to use this package in your own project.</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-kZhhr" id="tab-kUQieXt" checked="checked"><label for="tab-kUQieXt">npm</label><input type="radio" name="group-kZhhr" id="tab-vszbXHt"><label for="tab-vszbXHt">pnpm</label></div><div class="blocks"><div class="language-bash vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># initialize a demo project with a quick starter</span></span>
