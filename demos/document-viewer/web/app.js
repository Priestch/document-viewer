...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ViewerApp", [], factory);
	else if(typeof exports === 'object')
		exports["ViewerApp"] = factory();
	else
		root["ViewerApp"] = factory();
})(globalThis, () => {
...
exports.createViewerApp = createApp;
exports.getActiveApp = getActiveApp;
exports.getViewerConfiguration = getViewerConfiguration;
exports.initManager = initManager;
var _app2 = __webpack_require__(2);
var _application_options = __webpack_require__(54);
var _utils = __webpack_require__(55);
var _viewer_template = _interopRequireDefault(__webpack_require__(56));
...
function getViewerConfiguration(el) {
  return {
    ...
    toolbar: {
      ...
      openFile: el.querySelector("[data-dom-id='openFile']"),
    ...
    secondaryToolbar: {
      ...
      openFileButton: el.querySelector("[data-dom-id='secondaryOpenFile']"),
...
function createViewerApp(options) {
  ...
  const viewerOptions = new _application_options.AppOptions();
  ...
  (0, _utils.injectLocaleResource)(localeUrl);
  const app = new _app2.PDFViewerApplication(viewerOptions);
  activeApp = app;
  if (parent) {
    const template = (0, _viewer_template.default)();
...
var _app_helper = __webpack_require__(3);
var _default_app = __webpack_require__(8);
var _external_service = __webpack_require__(45);
class PDFViewerApplication extends _default_app.ViewerApplication {
  constructor(appOptions) {
    super();
    this.appOptions = appOptions;
    this.helper = (0, _app_helper.createHelper)(this);
    this.bindServices();
  }
  bindServices() {
    (0, _external_service.bindExternalService)(this);
    (0, _external_service.bindPrintServiceFactory)(_default_app.PDFPrintServiceFactory);
  }
  run(config) {
    const {
      validateFileURL
...
function createHelper(PDFViewerApplication) {
  ...
  async function loadFakeWorker() {
    _pdfjsLib.GlobalWorkerOptions.workerSrc ||= AppOptions.get("workerSrc");
...
exports.ViewerApplication = exports.PDFPrintServiceFactory = void 0;
var _ui_utils = __webpack_require__(4);
var _pdfjsLib = __webpack_require__(5);
var _app_options = __webpack_require__(9);
var _event_utils = __webpack_require__(10);
var _pdf_link_service = __webpack_require__(11);
var _webAlt_text_manager = __webpack_require__(12);
var _webAnnotation_editor_params = __webpack_require__(13);
var _overlay_manager = __webpack_require__(14);
var _password_prompt = __webpack_require__(15);
var _webPdf_attachment_viewer = __webpack_require__(16);
var _webPdf_cursor_tools = __webpack_require__(6);
var _webPdf_document_properties = __webpack_require__(18);
var _webPdf_find_bar = __webpack_require__(19);
var _pdf_find_controller = __webpack_require__(20);
var _pdf_history = __webpack_require__(22);
var _webPdf_layer_viewer = __webpack_require__(23);
var _webPdf_outline_viewer = __webpack_require__(24);
var _webPdf_presentation_mode = __webpack_require__(25);
var _pdf_rendering_queue = __webpack_require__(26);
var _pdf_scripting_manager = __webpack_require__(27);
var _webPdf_sidebar = __webpack_require__(28);
var _webPdf_thumbnail_viewer = __webpack_require__(29);
var _pdf_viewer = __webpack_require__(31);
var _webSecondary_toolbar = __webpack_require__(41);
var _webToolbar = __webpack_require__(42);
var _view_history = __webpack_require__(43);
var _default_external_services = __webpack_require__(44);
...
class ViewerApplication {
  ...
  baseUrl = "";
  _downloadUrl = "";
  externalServices = _default_external_services.DefaultExternalServices;
  ...
  async initialize(appConfig) {
    ...
    if (this.isViewerEmbedded && AppOptions.get("externalLinkTarget") === _pdf_link_service.LinkTarget.NONE) {
      AppOptions.set("externalLinkTarget", _pdf_link_service.LinkTarget.TOP);
    }
  ...
  async _parseHashParams() {
    ...
    if (params.has("textlayer")) {
      switch (params.get("textlayer")) {
        case "off":
          AppOptions.set("textLayerMode", _ui_utils.TextLayerMode.DISABLE);
          break;
        case "visible":
        case "shadow":
        case "hover":
  ...
  async _initializeViewerComponents() {
    ...
    const isOffscreenCanvasSupported = AppOptions.get("isOffscreenCanvasSupported") && _pdfjsLib.FeatureTest.isOffscreenCanvasSupported;
  ...
  async open(args) {
    ...
    const workerParams = AppOptions.getAll(_app_options.OptionKind.WORKER);
    Object.assign(_pdfjsLib.GlobalWorkerOptions, workerParams);
    if (args.url) {
      this.setTitleUsingUrl(args.originalUrl || args.url, args.url);
    }
    const apiParams = AppOptions.getAll(_app_options.OptionKind.API);
    const params = {
...
exports.ViewerApplication = ViewerApplication;
...
var _pdfjsLib = __webpack_require__(5);
var _base_tree_viewer = __webpack_require__(17);
var _event_utils = __webpack_require__(10);
...
var _pdfjsLib = __webpack_require__(5);
var _ui_utils = __webpack_require__(4);
var _annotation_editor_layer_builder = __webpack_require__(34);
...
exports.DefaultExternalServices = void 0;
var _pdfjsLib = __webpack_require__(5);
...
exports.bindPrintServiceFactory = exports.bindExternalService = void 0;
;
let bindPrintServiceFactory;
exports.bindPrintServiceFactory = bindPrintServiceFactory;
let bindExternalService;
exports.bindExternalService = bindExternalService;
;
{
  exports.bindExternalService = bindExternalService = (__webpack_require__(46).bindExternalService);
}
;
{
  exports.bindPrintServiceFactory = bindPrintServiceFactory = (__webpack_require__(52).bindPrintServiceFactory);
}
...
class GenericExternalServices extends _default_external_services.DefaultExternalServices {
  static createDownloadManager() {
...
function renderProgress(index, total, l10n) {
  const app = (0, _app_manager.getActiveApp)();
...
function ensureOverlay() {
  if (!overlayPromise) {
    ...
    app.appConfig.appContainer.querySelector(".printCancel").onclick = abort;
...
class ApplicationOptions {
  ...
  setAll(options, init = false) {
    if (init) {
      if (this.get("disablePreferences")) {
        return;
      }
      if (Object.keys(this.userOptions).length) {
...
exports.AppOptions = ApplicationOptions;
...
exports.injectLocaleResource = injectLocaleResource;
...
var _default = getViewerTemplate;
...
Object.defineProperty(exports, "createViewerApp", ({
  enumerable: true,
  get: function () {
    return _app_manager.createViewerApp;
  }
}));
Object.defineProperty(exports, "getViewerConfiguration", ({
  enumerable: true,
  get: function () {
    return _app_manager.getViewerConfiguration;
  }
}));
var _app_manager = __webpack_require__(1);
